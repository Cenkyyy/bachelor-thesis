public static class DeathChestInventoryTransferUtility
{
    public static void MoveBackpackItemsToDeathChest(PlayerInventory playerInventory, IInventory deathChestInventory)
    {
