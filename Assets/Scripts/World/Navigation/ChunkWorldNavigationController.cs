...
public sealed class ChunkWorldNavigationController : MonoBehaviour
{
    [Header("Dependencies")]
    ...
    public static ChunkWorldNavigationController Instance { get; private set; }
    ...
    public bool IsWorldPointWalkable(Vector2 worldPoint)
    {
        ...
        return _worldGenerator.CurrentWorldData.GetTile(dataTile.x, dataTile.y).TileType != TileType.Void;
    }
