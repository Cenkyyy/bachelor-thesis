...
{
    [Serializable]
    public sealed class ModifierSelectionRule : SelectionRuleBase<ModifierWord> { }

    [Serializable]
    public sealed class ElementSelectionRule : SelectionRuleBase<ElementWord> { }

    [Serializable]
    public sealed class FormSelectionRule : SelectionRuleBase<FormWord> { }
